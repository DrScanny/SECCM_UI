...
class SECCM_PI(QObject): 
    ...
    def __init__(self, threadInstance:QThread, PIdevice:dict[str,GCSDevice], SECCMsettings:UI_Settings.SECCM, mapCoordinates, event:dict[str,threading.Event], file):
        super().__init__()
...
class SECCM_BL(QObject): 
    ...
    def __init__(self, threadInstance:QThread, potentiostat, SECCMsettings: UI_Settings.SECCM, techniqueList, event:dict[str,threading.Event], file):
        super().__init__()
