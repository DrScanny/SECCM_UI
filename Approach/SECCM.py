...
#region: SECCM Positioner  
class SECCM_Positioners(QObject): 
    ...
    #---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    #region: SECCM Potentiostat
    class SECCM_Biologic(QObject): 
        ...
        def approach(self):
            ...
            while True: #Primary While loop -> Repeat tip down measurement until trigger or max range hit
                ...
                print("[APPROACH] VMP-300 tip down")
                self.loadTechnique() 
        ...
        def tipStop(self, potentiostatOutput):
