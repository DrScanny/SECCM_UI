...
class SECM_PI(QObject): 
    ...
    def __init__(self, threadInstance:QThread, PIdevice:dict[str,GCSDevice], SECMsettings:UI_Settings.SECM, event:dict[str,threading.Event], file):
        super().__init__()
    ...
    def approach(self):
        ...
        try:
            ...
            #Waiting 3 sec to let potentiostat measure bulk current for SECM approach
            time.sleep(3)
            ...
            while True:
                ...
                print(f"[SECM] Piezo Approaching")
...
class SECM_BL(QObject): 
    ...
    def __init__(self, threadInstance:QThread, potentiostat, SECMsettings: UI_Settings.SECM, event:dict[str,threading.Event], file):
        super().__init__()
    ...
    def approach(self):
        ...
        try:
            print(self.settings)
            self.writer.writeSECMSettings(self.settings)
