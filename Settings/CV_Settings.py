...
class CVset(QWidget):
    ...
    def __init__(self):
        ...
        self.settings= SECCM_Settings.CVsettings()
    ...
    def setupUi(self):
        ...
        self.eiLabel= QLabel("From E<sub>i</sub>"); self.layoutRange.addWidget(self.eiLabel, 0,0)
        ...
        self.efLabel= QLabel("End at E<sub>f</sub>"); self.layoutRange.addWidget(self.efLabel, 3,0)
