...
class Device(QWidget):
    ...
    def connectDevices(self, device:int):
        ...
        match device:
            ...
            case 1: # Piezo stage
                connectionStatus= self.positioner.connectPositioner(address, 'Pz')

            case 2: # Z stage
                connectionStatus= self.positioner.connectPositioner(address, 'Z')

            case 3: # XY stage
                connectionStatus= self.positioner.connectPositioner(address, 'XY')
